...
# Загрузка модели
try:
    model = load_model('multi_crypto_lstm_model.keras')
...
for coin in coins:
    ...
    plt.legend()
    plt.savefig(f'prediction_{coin}.png')
    plt.show()
    ...
    print(f"Предсказанная цена {coin} на 11 апреля 2025: {next_day_pred[0]:.2f} USDT")
